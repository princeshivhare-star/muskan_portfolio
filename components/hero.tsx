...
export function Hero() {
  return (
    <section
      id="about"
      className="font-stack-sans relative overflow-hidden bg-background px-5 pb-14 pt-20 text-foreground md:px-8 md:pb-20 md:pt-28 lg:min-h-[595px] lg:px-0 lg:pt-[124px]"
    >
      <div className="mx-auto grid w-full max-w-[923px] grid-cols-1 items-start lg:grid-cols-[268px_354px_301px] lg:origin-top lg:scale-[1.1]">
        ...
        <div className="order-3 hidden lg:mt-[216px] lg:flex lg:justify-end">
          <p className="max-w-[150px] text-right text-[1.32rem] font-medium leading-[0.86] tracking-[-0.018em] text-foreground lg:-translate-x-[46px]">
            Strategic
            <br />
            Emerging
            <br />
